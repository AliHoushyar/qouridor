    		...
    		if (move == 1) {
                ...
                while(1){
                    ...
                    if ((x >= gameMap.n - 1 && (c=='v' || c=='V')) || (y >= gameMap.m - 1 && (c=='h' || c=='H'))) {
                        ...
                        printf("Error! you have entered invalid location(you can't place a wall there) or charachter! try again: \n");
                        continue;
                    }
                }
            }
			else {
				printf("you have entered invalid location(you can't place a wall there) or charachter! try again!\n");
				continue;
			}
		}
		else {
    		...
    		if (move == 1) {
                ...
                while(1){
                    ...
                    if (x >= gameMap.n - 1 || y >= gameMap.m - 1) {
                        ...
                        printf("Error! you have entered invalid location (you can't place a wall there) or character! try again: \n");
                        continue;
                    }
                }
            }
			else {
				printf("you have entered invalid location (you can't place a wall there) or character! try again!\n");
				continue;
			}
		}
	} while(1);
